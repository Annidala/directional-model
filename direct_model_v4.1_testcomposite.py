...
def _createDirectionVector(Nbfiber,theta0, dthet):
	...
	um=np.array([um])
	for i in Nbfiber:
		ui=[math.cos(i*dthet+theta0),math.sin(i*dthet+theta0)]
...
### Orientation distribution of the knitted textile
Nbdirm=[0,1,3,4,5,7]
theta0=0
dthet=np.pi/4
utext=_createDirectionVector(Nbdirm,theta0,dthet) 

### orientations star


#### material direction definition of matrix
